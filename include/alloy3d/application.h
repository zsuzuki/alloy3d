...
public:
  ...
  virtual void DrawRoundRect(simd_float2 from, simd_float2 to, float radius, simd_float4 color) = 0;
  virtual void FillRect(simd_float2 from, simd_float2 to, simd_float4 color)                    = 0;
  virtual void FillRoundRect(simd_float2 from, simd_float2 to, float radius, simd_float4 color) = 0;
  ...
  // Source defines ModelMaterial alloy3dMaterial(ModelMaterial m, ModelMaterialContext c, float4
  // p). Edits material inputs before the library's lighting, shadows and fog.
  virtual ModelShaderPtr CreateModelMaterialShader(std::string_view source,
  ...
  virtual bool SetModelTextureTransform3D(const ModelTextureTransform3D &transform)
  {
    return false;
  }
  ...
  virtual void DrawPlane3D(simd_float3 p0, simd_float3 p1, simd_float3 p2, simd_float3 p3,
                           simd_float4 color)                                             = 0;
  virtual void DrawSphere3D(simd_float3 center, float radius, simd_float4 color, int slices = 24,
                            int stacks = 12)                                              = 0;
  ...
  virtual void DrawCylinder3D(simd_float3 center, float radius, float height, simd_float4 color,
                              int segments = 24)                                          = 0;
  virtual void DrawCylinder3D(simd_float3 center, float radius, float height, simd_float3 rotation,
  ...
  virtual void DrawText3D(std::string_view msg, simd_float3 position, float lineHeight,
                          simd_float4 color, TextAlign3D align = TextAlign3D::LeftBottom) = 0;
  virtual void DrawText3D(std::string_view msg, simd_float3 position, float lineHeight,
  ...
  virtual void DrawModel3D(ModelPtr model, simd_float3 position, simd_float3 rotation,
                           simd_float3 scale,
