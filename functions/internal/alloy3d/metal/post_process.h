...
class PostProcess
{
  struct Page { id<MTLTexture> color=nil, multisample=nil, bloom=nil, bloomScratch=nil, depth=nil, sceneColor=nil, sceneDepth=nil, volume=nil; bool releasePending=false; };
...
public:
  PostProcess(id<MTLDevice>,id<MTLLibrary>,MTLPixelFormat colorFormat,MTLPixelFormat depthFormat,NSUInteger samples,bool sceneEffects=false);
  ~PostProcess();
  ...
  void setVolumeScene(const CameraData &,simd_float3 lightDirection,simd_float3 lightColor,
      simd_float4x4 shadowTransform,simd_float4 shadowParameters,id<MTLTexture> shadowMap);
