...
class PostProcess
{
  struct Page { id<MTLTexture> color=nil, multisample=nil, bloom=nil, bloomScratch=nil, depth=nil, sceneColor=nil, sceneDepth=nil; bool releasePending=false; };
  ...
  NSUInteger samples_;
  bool sceneEffects_;
  id<MTLComputePipelineState> depthPipeline_=nil;
